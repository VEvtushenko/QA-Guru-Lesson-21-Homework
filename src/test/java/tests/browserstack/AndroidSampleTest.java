...
import static tests.browserstack.TestBase.setCapabilities;
...
//                new URL("http://hub-cloud.browserstack.com/wd/hub"), caps);
        ...
        // Initialise the remote Webdriver using BrowserStack remote URL
        // and desired capabilities defined above
        AndroidDriver<AndroidElement> driver = initAndroidDriver(setCapabilities(new File("src/test/resources/run_first_test/first.conf.json")));
